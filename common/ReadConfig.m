...
for i = 1:size(InLines,1)
  ...
  switch Fields{1}
    ...
    case 'HmeasPlot3d:'
      ...
      Cdata.HmeasPlot3d(i_hmp3d).Descrip = regexprep(Fields{4}, '_', ' ');
      Cdata.HmeasPlot3d(i_hmp3d).Units   = Fields{5};
      Cdata.HmeasPlot3d(i_hmp3d).Vtype   = Fields{6};
      Cdata.HmeasPlot3d(i_hmp3d).Isurf   = sscanf(Fields{7}, '%f');
      Cdata.HmeasPlot3d(i_hmp3d).Rmin    = sscanf(Fields{8}, '%f');
      Cdata.HmeasPlot3d(i_hmp3d).Rmax    = sscanf(Fields{9}, '%f');
      Cdata.HmeasPlot3d(i_hmp3d).Zmin    = sscanf(Fields{10},'%f');
      Cdata.HmeasPlot3d(i_hmp3d).Zmax    = sscanf(Fields{11},'%f');
      Cdata.HmeasPlot3d(i_hmp3d).Tmin    = sscanf(Fields{12},'%f');
      Cdata.HmeasPlot3d(i_hmp3d).Tmax    = sscanf(Fields{13},'%f');
      Cdata.HmeasPlot3d(i_hmp3d).Cmin    = sscanf(Fields{14},'%f');
      Cdata.HmeasPlot3d(i_hmp3d).Cmax    = sscanf(Fields{15},'%f');
    case 'ProfPlot:'
      i_pplot = i_pplot + 1;
