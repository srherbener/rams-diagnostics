...
AxisProps(iaxis).Name = 'Ylim';
AxisProps(iaxis).Val  = [ 0 1 ];
PlotBarSet(X, COT_LB1_A, '0.01 mm < LWP < 0.10 mm', { 'b' }, Xlabel, COTlabel, Bcolors, LegText, 'NorthWest', AxisProps, COT_LB1_Afile);

AxisProps(iaxis).Name = 'Ylim';
AxisProps(iaxis).Val  = [ 0 8 ];
PlotBarSet(X, COT_LB2_A, '0.10 mm < LWP < 1.00 mm', { 'c' }, Xlabel, COTlabel, Bcolors, LegText, 'NorthWest', AxisProps, COT_LB2_Afile);

AxisProps(iaxis).Name = 'Ylim';
AxisProps(iaxis).Val  = [ 0 100 ];
PlotBarSet(X, COT_LB3_A, 'LWP > 1.00 mm', { 'd' }, Xlabel, COTlabel, Bcolors, LegText, 'NorthWest', AxisProps, COT_LB3_Afile);
