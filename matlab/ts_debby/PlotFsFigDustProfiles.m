...
%    { 'TSD_NONSAL_NODUST'  'NSND' 'green' }
  ...
  Paxes = subplot(2,2,1);
  PlotFsFigLine(Paxes, Dust1Core, Z, 'a', 'SAL: Core', 'Dust1 Num (cm^-^3)', Xlim, 1, 'Height (km)', Ylim, 1, Fsize, LegText, 'NorthEast', Colors);

  Paxes = subplot(2,2,2);
  PlotFsFigLine(Paxes, Dust1Rband, Z, 'b', 'SAL: Rband', 'Dust1 Num (cm^-^3)', Xlim, 1, 'Height (km)', Ylim, 1, Fsize, LegText, 'none', Colors);

  Paxes = subplot(2,2,3);
  PlotFsFigLine(Paxes, Dust2Core, Z, 'c', 'SAL: Core', 'Dust2 Num (cm^-^3)', Xlim, 1, 'Height (km)', Ylim, 1, Fsize, LegText, 'none', Colors);

  Paxes = subplot(2,2,4);
  PlotFsFigLine(Paxes, Dust2Rband, Z, 'd', 'SAL: Rband', 'Dust2 Num (cm^-^3)', Xlim, 1, 'Height (km)', Ylim, 1, Fsize, LegText, 'none', Colors);
