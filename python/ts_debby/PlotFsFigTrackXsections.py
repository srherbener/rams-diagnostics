...
TempcNvPressPsap = ffc.TrackXsectionPress(AvgFname, '/ps_tempc_nv_p', 'Plots.py/FsFigPtrackTempcNvPressPsapFactors.png', 'T,\\ ^{\\circ}C', 'PSAP', SimCspecs, FactCspecs, 'ptrack')
TempcNvPressPsap.CreateFig()

TempcNvPressSap = ffc.TrackXsectionPress(AvgFname, '/s_tempc_nv_p', 'Plots.py/FsFigPtrackTempcNvPressSapFactors.png', 'T,\\ ^{\\circ}C', 'SAP', SimCspecs, FactCspecs, 'ptrack')
...
VaporNvPressPsap = ffc.TrackXsectionPress(AvgFname, '/ps_vapor_nv_p', 'Plots.py/FsFigPtrackVaporNvPressPsapFactors.png', 'Vapor', 'PSAP', SimCspecs, FactCspecs, 'ptrack')
VaporNvPressPsap.CreateFig()

VaporNvPressSap = ffc.TrackXsectionPress(AvgFname, '/s_vapor_nv_p', 'Plots.py/FsFigPtrackVaporNvPressSapFactors.png', 'Vapor', 'SAP', SimCspecs, FactCspecs, 'ptrack')
...
TempcGradNvPressPsap = ffc.TrackXsectionPress(TgradFname, '/ps_tempc_nv_p_hgrad_smooth', 'Plots.py/FsFigPtrackTempcGradNvPressPsapFactors.png', '{\\nabla}T', 'PSAP', SimCspecs, FactCspecs, 'ptrack')
TempcGradNvPressPsap.InScale = 1.0e3
TempcGradNvPressPsap.CreateFig()

TempcGradNvPressSap = ffc.TrackXsectionPress(TgradFname, '/s_tempc_nv_p_hgrad_smooth', 'Plots.py/FsFigPtrackTempcGradNvPressSapFactors.png', '{\\nabla}T', 'SAP', SimCspecs, FactCspecs, 'ptrack')
TempcGradNvPressSap.InScale = 1.0e3
TempcGradNvPressSap.CreateFig()


#######################################
###### Vertical coord --> Height ######
#######################################
