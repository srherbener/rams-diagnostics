...
MagShear10 = ffc.PlanView(InFname, '/mag_shear_10', 'Plots.py/FsFigWindShear10.png', '|Shear|', '22Aug, 06Z', SimCspecs, FactCspecs)
MagShear10.CreateFig()

MagShear20 = ffc.PlanView(InFname, '/mag_shear_20', 'Plots.py/FsFigWindShear20.png', '|Shear|', '22Aug, 16Z', SimCspecs, FactCspecs)
MagShear20.CreateFig()

MagShear30 = ffc.PlanView(InFname, '/mag_shear_30', 'Plots.py/FsFigWindShear30.png', '|Shear|', '23Aug, 02Z', SimCspecs, FactCspecs)
MagShear30.CreateFig()

MagShear40 = ffc.PlanView(InFname, '/mag_shear_40', 'Plots.py/FsFigWindShear40.png', '|Shear|', '23Aug, 12Z', SimCspecs, FactCspecs)
