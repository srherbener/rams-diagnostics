...
%
%   EXAMPLES
%     c = str2rgb('DarkRed')               gives c = [0.5430 0 0]
%     c = str2rgb('Green')                 gives c = [0 0.5 0]
%     plot(x,y,'color',str2rgb('orange'))  plots an orange line through x and y
%     str2rgb chart                        shows all the colors
%
%   BACKGROUND
...
function [ rgb ] = str2rgb(s)
  persistent num name
  if isempty(num) % First time str2rgb is called
    [num,name] = getcolors();
    name = lower(name);
