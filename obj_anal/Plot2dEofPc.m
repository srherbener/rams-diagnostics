function [ ] = Plot2dEofPc( EOF, PC, N, X, Y, Clevs, Cbounds, ObsDescrip, Exp, E_xlabel, E_ylabel, P_ylabel, OutFile )
...
Fig = figure;
subplot(2,1,1);
Plot2dMap(Fig,X,Y,EOF(:,N)', Clevs, Cbounds, E_xlabel, E_ylabel, E_title);
subplot(2,1,2);
plot(PC(:,N)');
title(P_title);
xlabel('Timestep');
