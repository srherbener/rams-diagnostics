...
dx = 0.25; dy = 0.25; % grid spacing in km

%Vdir = 'VAPOR_C0050_S293'; % directory
%Vdir = 'VAPOR_C0400_S293';
%Vdir = 'VAPOR_C1600_S293';

%Vdir = 'VAPOR_C0050_S298';
%Vdir = 'VAPOR_C0400_S298';
Vdir = 'VAPOR_C1600_S298';

%Vdir = 'VAPOR_C1600_S303';
...
InFilesPath = '../HDF5/';
InFiles = {  % REVU H5 output file name
  %'cloud-z.atex.ccn0050.sst293.gcn10m5.1um-AS-1999-02-10-040000-g1.h5'
  %'cloud-z.atex.ccn0400.sst293.gcn10m5.1um-AS-1999-02-10-040000-g1.h5'
  %'cloud-z.atex.ccn1600.sst293.gcn10m5.1um-AS-1999-02-10-040000-g1.h5'
  
  %'cloud-z.atex.ccn0050.sst298.gcn10m5.1um-AS-1999-02-10-040000-g1.h5'
  %'cloud-z.atex.ccn0400.sst298.gcn10m5.1um-AS-1999-02-10-040000-g1.h5'
  'cloud-z.atex.ccn1600.sst298.gcn10m5.1um-AS-1999-02-10-040000-g1.h5'
  
  %'cloud-z.atex.ccn1600.sst303.gcn10m5.1um-AS-1999-02-10-040000-g1.h5'
  };
